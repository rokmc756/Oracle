...
do
   ...
   ssh root@$i "systemctl stop dbora"
   ssh root@$i "systemctl disable dbora"
   ssh root@$i "rm -f /etc/systemd/system/dbora.service"
   ...
   ssh root@$i "rm -rf /u01 /u02 /etc/oraInst.loc /etc/oratab /opt/ORCLfmap /home/oracle"
